...
ReactDOM.render(
  <React.StrictMode>
    ...
    <p> Change an article here and the app will update the content of <strong>5</strong> different sites on <strong>2</strong> seperate servers automatically</p>
    <hr class="my-4"/>
    ...
    <p class="lead">
    <a class="btn btn-warning btn-lg" href="https://d8app.gliese.thehubdigital.co" role="button">See the jQuery app</a>
    </p>
    <p class="lead">
    <a class="btn btn-success btn-lg" href="https://reactapp.myjamjar.com.au" role="button">Server 2 React App</a> 
    </p>
    <p class="lead">
    <a class="btn btn-danger btn-lg" href="https://jqapp.myjamjar.com.au" role="button">Server 2 jQuery app</a>
    </p>
    </div>
    </header>
    <App />
